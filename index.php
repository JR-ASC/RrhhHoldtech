<!DOCTYPE html>
<!--
index.php trabaja con login.php ubicado en php/login.php, para poder obsevar el diseño de la pagina comentar el codigo php
incrustado en el que se encuentra el include.
-->
<?php
...
<html>
    ...
    <body>
      ...
      <!-- scrip para iniciar el contenedor del fondo movil -->
      <script src="js/init.js"></script>
      <!-- script para inicializar el boton colapsable en version mobile -->
